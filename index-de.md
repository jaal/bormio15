...
<form id="booking-form" class="booking-form">
  <div class="form-row">
    <div class="form-group">
      <label for="start-date">Anreisedatum * <small>(TT.MM.JJJJ)</small></label>
      <input type="date" id="start-date" name="start-date" required title="Wählen Sie das Anreisedatum">
    </div>

    <div class="form-group">
      <label for="end-date">Abreisedatum * <small>(TT.MM.JJJJ)</small></label>
      <input type="date" id="end-date" name="end-date" required title="Wählen Sie das Abreisedatum">
    </div>
  </div>
  ...
  kidsCountInput.addEventListener('input', function() {
    ...
    if (numKids > 0) {
      ...
      for (let i = 0; i < numKids; i++) {
        ...
        ageInput.innerHTML = `
          <label for="kid-age-${i}">Alter des Kindes ${i + 1} *</label>
